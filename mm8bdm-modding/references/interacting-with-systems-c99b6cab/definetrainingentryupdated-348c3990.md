---
title: "DefineTrainingEntryUpdated"
notion_id: 348c39906f4f4617acf43c95b1b9d31f
source: https://www.notion.so/348c39906f4f4617acf43c95b1b9d31f
---
...
> ⚡ int DefineTrainingEntryUpdated(str version, int type, str tag, str desc, str icon, str actor)

## Usage

---

This function performs the same role and should be used in the same context as [DefineTrainingEntry](./definetrainingentry-91396e36.md), but allows you to specify a message indicating the weapon as updated in some version. Base MM8BDM uses this for its updated weapons and items to tell people to check out the new updates.
